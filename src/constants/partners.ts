...
export const PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    category: "company",
    description:
      "KLab is Rwanda's leading tech innovation hub, supporting startups and developers with workspace, mentorship, and a thriving tech community.",
    website: "https://klab.rw",
    logo: klab,
    initials: "KL",
    bg: "#e85d00",
    since: "2025",
    collab: "Event hosting, workspace access, startup ecosystem",
    featured: false,
  },
  {
    id: 7,
    ...
    category: "company",
    description:
      "WikiSuite is a comprehensive open-source enterprise suite providing collaboration, communication, and knowledge management tools.",
