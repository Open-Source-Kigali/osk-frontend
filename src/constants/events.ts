...
export const EVENTS: OSKEvent[] = [
  ...
  },
  {
    ...
    location: "Virtual (WhatsApp/Zoom)",
    attendees: 34,
    capacity: null,
    speakers: [{ name: "Tech Lead", role: "OSK Maintainer", initials: "TL" }],
    tags: ["node.js", "api", "auth"],
    featured: false,
    registerUrl: "https://chat.whatsapp.com/GimdjJcYLyyG62zpgsI0zB",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    featured: false,
    registerUrl: "",
    recapUrl: "https://github.com/open-source-kigali",
    recordingUrl: "https://github.com/open-source-kigali",
  },
];
