      ...
      <div className="max-w-7xl mx-auto px-4 md:px-20 py-16">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600">
          ...
          <div className="flex gap-5">
            ...
            <NavLink to="https://docs.google.com/document/d/1K_bIZT09p-8IiPpg1v3RsMD2dZmUzRFWlMp8tfOavcE/edit?usp=sharing" className="hover:text-gray-400 transition" target="_blank">
              Code of Conduct
            </NavLink>
